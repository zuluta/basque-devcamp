...
<p><code>.navbar</code> es un <strong>bloque grid</strong>, el bloque se divide en <strong>2 columnas</strong>, la primera columna ocupa un ancho de 180px y la segunda el 100% restante y le hemos definido un color de fondo negro.</p>
<br>
...
<p><code>.navbar-content</code> es un <strong>bloque grid</strong> con <strong>2 columnas</strong> iguales.</p>
<br>
...
```
<p>Ahora que hemos completado el <strong>bloque izquierdo</strong> con los elementos <strong>EXPLORE</strong>, <strong>links de navegación</strong> y <strong>Spark con chevron</strong>, pasaremos a contruir un nuevo bloque para el lado derecho.</p>
<br>
...
<br>
<p>El código de este archivo adapta el contenido de la página web a diferentes tipos de <strong>dispositivos</strong>.</p>
