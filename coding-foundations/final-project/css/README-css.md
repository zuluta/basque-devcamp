...
.navbar {                             /* hace referencia a la clase navbar */
    display: grid;                    /* define el tipo de bloque a grid. */
    grid-template-columns: 180px 1fr; /* asigna 2 columnas al bloque grid. */
...
```css
.navbar > .navbar-logo {   /* hace referencia a la clase */
    display: grid;         /* define el tipo de bloque a grid. */
...
.navbar > .navbar-logo img { /* hace referencia a la etiqueta */
