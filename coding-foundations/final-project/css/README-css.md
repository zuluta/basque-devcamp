...
<p><code>.navbar</code> construimos un bloque grid, el bloque se divide en 2 columnas, primera con un ancho de 180px y la segunda el 100% restante. Asignamos un alto automático para adaptar su contenido, por último se le da un color de fondo deseado.</p>
<br>
