...
![banner copy](https://github.com/zuluta/basque-devcamp/blob/3e41f4c3da1fa3a70a71cc5b46f5310bfee4a73c/coding-foundations/final-project/img/screenshot/finished-project.png)

<p>Para dar estilo a la página web se ha hecho uso de CSS (Hojas de Estilo en Cascada).</p>

> [!NOTE]
> Se muestra una lista de archivos creada para el proyecto:
> * [basic.css](#basic)
> * [navbar.css](#navbar)
> * [article.css](#article)
> * [section.css](#section)
