...
<p>Para construir la página web se ha hecho uso de HTML y CSS.</p>

<p>Primero, vamos a empezar visualizando el código html y describiendo algunas partes del código para entender como se ha estructurado la página web.</p>
